...
#		self.def_clrbackground = self.clrbackground = (wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWFRAME)).Get(False)
		...
		self.orbis = [
			[9.0, 9.0, 9.0, 9.0, 9.0, 4.0, 4.0, 1.75, 1.75, 1.75, 5.0],  # Солнце
			[9.0, 9.0, 9.0, 9.0, 9.0, 4.0, 4.0, 1.75, 1.75, 1.75, 5.0],  # Луна
			[8.0, 6.0, 7.0, 6.0, 6.0, 3.0, 3.0, 1.5, 1.5, 1.5, 3.5],  # Меркурий
			[8.0, 6.0, 7.0, 6.0, 6.0, 3.0, 3.0, 1.5, 1.5, 1.5, 3.5],  # Венера
			[8.0, 6.0, 7.0, 6.0, 6.0, 3.0, 3.0, 1.5, 1.5, 1.5, 3.5],  # Марс
			[6.0, 5.0, 5.0, 4.0, 4.0, 3.5, 3.5, 1.5, 1.5, 1.5, 4.0],  # Юпитер
			[6.0, 5.0, 5.0, 4.0, 4.0, 3.5, 3.5, 1.5, 1.5, 1.5, 4.0],  # Сатурн
			[5.0, 4.0, 4.0, 3.0, 3.0, 2.5, 2.5, 1.0, 1.0, 1.0, 3.0],  # Уран
			[5.0, 4.0, 4.0, 3.0, 3.0, 2.5, 2.5, 1.0, 1.0, 1.0, 3.0],  # Нептун
			[5.0, 4.0, 4.0, 3.0, 3.0, 2.5, 2.5, 1.0, 1.0, 1.0, 3.0],  # Плутон
			[0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5]  # Средний Узел
		]
